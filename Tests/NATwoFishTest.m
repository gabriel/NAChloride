...
- (void)test {
  ...
  NSData *encrypted = [NATwoFish encrypt:message nonce:nonce key:key error:&error];
  ...
  NSData *decrypted = [NATwoFish decrypt:encrypted nonce:nonce key:key error:&error];
